...
public class ArithmeticExpressionLexer extends Lexer {
	...
	public static final int
		SumOperators=1, MultOperators=2, AtrOperator=3, OP=4, CP=5, Letter=6, 
		Digit=7, WS=8;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SumOperators", "MultOperators", "AtrOperator", "OP", "CP", "Letter", 
			"Digit", "WS"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "SumOperators", "MultOperators", "AtrOperator", "OP", "CP", "Letter", 
			"Digit", "WS"
		};
	}
